# ai-draft-review Specification

## Purpose

Let an authenticated user request AI-generated card drafts from inside a deck, review and edit those drafts under the same validation rules as manual cards, and save the selected drafts into the deck.
