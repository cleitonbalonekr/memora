...
Define how the flashcards app is made installable as a Progressive Web App so users can add it to their home screen or app launcher and study with an app-like, standalone experience on both Android and iOS.
...
- **WHEN** a user launches the installed app on a supported iOS device
