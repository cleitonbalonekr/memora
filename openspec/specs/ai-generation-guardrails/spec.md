# ai-generation-guardrails Specification

## Purpose

Constrain AI card generation to control cost and protect the system: bound output size per card and per request, rate-limit generation per user, and fail safely without leaking provider internals.
